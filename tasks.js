...
// var pk = new Date(now.getFullYear(), 8, 14);
// if (now.getMonth() == 8 && now.getDate() > 14) {
//     pk.setFullYear(pk.getFullYear() + 1);
// }
// var one_day = 1000 * 60 * 60 * 24;
// let aug = Math.ceil((pk.getTime() - now.getTime()) / (one_day));
// if (aug < 0) {
//     aug = aug + 365;
// }
// console.log(aug + " days left until 14 August!");


let d8 = new Date();
d8.setFullYear(d8.getFullYear() + 1, 7, 14);

var Difference_In_Time = now.getTime() - d8.getTime();
  
var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24);

console.log( "Difference in today and 14 august: ", Math.floor(Difference_In_Days < 0 ? Difference_In_Days * -1 : Difference_In_Days));
